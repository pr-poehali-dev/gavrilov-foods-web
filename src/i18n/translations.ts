...
export const translations = {
  en: {
    ...
    organic: {
      ...
      wholesaleNote: "Wholesale supply with export documentation — organic & conventional, FOB / DDP terms available.",
    ...
    certifications: {
      ...
      organicAvailableList: ["Buckwheat", "Green Buckwheat", "Buckwheat Flour", "Oat Flakes"],
      packagingSupplyTitle: "Packaging & Supply",
      packagingSupplySub: "Flexible solutions for different needs",
      packagingSupplyItems: [
        { title: "Retail Packaging", size: "250 g – 5 kg", desc: "Custom options available" },
        { title: "Industrial Packaging", size: "25 kg / 50 kg bags", desc: "High quality packaging" },
        { title: "Bulk Supply", size: "500 – 1,000 kg\nBig Bags", desc: "For large volume orders" },
        { title: "Container Shipping", size: "20 ft / 40 ft", desc: "Safe and secure delivery" },
      ],
    },
    privateLabel: {
      ...
      trustItems: [
        { title: "Own Farmland", desc: "10,000+ ha of own certified farmland — full control from field to processing." },
        { title: "Quality Control", desc: "In-house lab testing at every stage to meet international standards." },
        { title: "Private Label", desc: "Retail-ready packaging with custom design for your brand." },
        { title: "Export Docs", desc: "Phytosanitary certificates, international experience with global markets." },
      ],
      whyBuyersTitle: "Why Buyers Trust Gavrilov Foods",
      whyBuyersItems: [
        { title: "Own Farmland", desc: "10,000+ ha — full control from seed to harvest" },
        { title: "Quality Control", desc: "In-house lab testing at every stage" },
        { title: "Full Traceability", desc: "Transparent, field-to-shipment supply chain" },
        { title: "EU Organic Certified", desc: "Certified organic products for selected categories" },
        { title: "Export Experience", desc: "International markets, phytosanitary docs, FCL" },
      ],
    ...
    contact: {
      ...
      requestSubtitle: "Tell us about your needs and our export team will send you a competitive offer within 24 hours.",
      ...
      formMessage: "Message *",
      formMessagePlaceholder: "Volume, packaging, destination country, any specific requirements...",
      ...
      trustIcons: ["Quality You Can Trust", "On-Time Delivery", "Competitive Prices", "Long-term Partnership"],
      featureBadges: [
        { title: "EU Organic Certified", desc: "Certified organic products for global markets." },
        { title: "MOQ from 22 MT", desc: "Flexible minimum order quantity from 22 MT." },
        { title: "Private Label", desc: "Custom packaging and private label solutions." },
        { title: "Export Support", desc: "Full documentation and logistics support at every step." },
        { title: "Fast Response", desc: "We reply within 24 hours on business days." },
      ],
      sendRequest: "Send us your request",
      selectProduct: "Select product",
      selectPackaging: "Select packaging",
      selectVolume: "Select volume",
      privacyText: "I agree to the {privacyLink} and {termsLink} of Gavrilov Foods and consent to the processing of my personal data for export inquiry purposes.",
      privacyLinkText: "Privacy Policy",
      termsLinkText: "Terms & Conditions",
      packagingOpts: ["250g – 5kg retail bags", "25 / 50 kg bags", "500–1000 kg Big Bags", "20 ft container", "40 ft container"],
      volumeOpts: ["1–5 MT", "5–20 MT", "20–100 MT", "100+ MT", "Full container (FCL)"],
      productOpts: ["Buckwheat", "Green Buckwheat", "Buckwheat Flour", "Oat Flakes", "Red Lentils", "Yellow Peas", "Chickpeas", "Wheat"],
    },
    footer: {
      tagline:
      ...
      brandFeatures: ["Organic grains, pulses & oilseeds", "EU-certified production"],
      brandLocation: "Smolensk Region, Russia",
      brandMission: "Working with importers worldwide\nto deliver quality and value.",
      quickLinks: "Quick Links",
      quickLinksItems: ["About Us", "Our Products", "Organic", "Export", "Certifications", "Private Label", "Gallery"],
  ...
  ru: {
    ...
    organic: {
      ...
      wholesaleNote: "Оптовые поставки с экспортной документацией — органик и традиционный, условия FOB / DDP по запросу.",
    ...
    certifications: {
      ...
      organicAvailableList: ["Гречка", "Зелёная гречка", "Гречневая мука", "Овсяные хлопья"],
      packagingSupplyTitle: "Упаковка и поставки",
      packagingSupplySub: "Гибкие решения для разных потребностей",
      packagingSupplyItems: [
        { title: "Розничная упаковка", size: "250 г – 5 кг", desc: "Варианты на заказ" },
        { title: "Промышленная упаковка", size: "Мешки 25 кг / 50 кг", desc: "Высококачественная упаковка" },
        { title: "Оптовые поставки", size: "500 – 1 000 кг\nБиг-бэги", desc: "Для крупных объёмов заказов" },
        { title: "Контейнерная доставка", size: "20 / 40 фут", desc: "Безопасная и надёжная доставка" },
      ],
    },
    privateLabel: {
      ...
      trustItems: [
        { title: "Собственная пашня", desc: "10 000+ га собственной сертифицированной пашни — полный контроль от поля до переработки." },
        { title: "Контроль качества", desc: "Внутреннее лабораторное тестирование на каждом этапе по международным стандартам." },
        { title: "Частная марка", desc: "Упаковка, готовая к продаже, с индивидуальным дизайном для вашего бренда." },
        { title: "Экспортные документы", desc: "Фитосанитарные сертификаты, международный опыт работы с мировыми рынками." },
      ],
      whyBuyersTitle: "Почему покупатели доверяют Gavrilov Foods",
      whyBuyersItems: [
        { title: "Собственная пашня", desc: "10 000+ га — полный контроль от семени до урожая" },
        { title: "Контроль качества", desc: "Внутреннее лабораторное тестирование на каждом этапе" },
        { title: "Полная прослеживаемость", desc: "Прозрачная цепочка поставок от поля до отгрузки" },
        { title: "Сертификат органик ЕС", desc: "Органические продукты для выбранных категорий" },
        { title: "Экспортный опыт", desc: "Международные рынки, фитосанитарные документы, FCL" },
      ],
    ...
    contact: {
      ...
      requestSubtitle: "Расскажите о ваших потребностях, и наша экспортная команда пришлёт конкурентное предложение в течение 24 часов.",
      ...
      formMessagePlaceholder: "Объём, упаковка, страна назначения, особые требования...",
      formPrivacyNote: "Пожалуйста, примите Политику конфиденциальности и Условия для продолжения",
      formSubmitBtn: "Запросить экспортное предложение",
      whatsappExport: "WhatsApp менеджер по экспорту",
      trustIcons: ["Качество, которому доверяют", "Доставка в срок", "Конкурентные цены", "Долгосрочное партнёрство"],
      featureBadges: [
        { title: "Сертификат органик ЕС", desc: "Органические продукты для мировых рынков." },
        { title: "МОК от 22 т", desc: "Гибкий минимальный объём заказа от 22 т." },
        { title: "Частная марка", desc: "Упаковка на заказ и решения для частной марки." },
        { title: "Экспортная поддержка", desc: "Полная документация и логистическая поддержка на каждом этапе." },
        { title: "Быстрый ответ", desc: "Отвечаем в течение 24 часов в рабочие дни." },
      ],
      ...
      privacyText: "Я согласен с {privacyLink} и {termsLink} Gavrilov Foods и даю согласие на обработку моих персональных данных в целях обработки экспортного запроса.",
      privacyLinkText: "Политикой конфиденциальности",
      termsLinkText: "Условиями и положениями",
      packagingOpts: ["Розничные пакеты 250г – 5кг", "Мешки 25 / 50 кг", "Биг-бэги 500–1000 кг", "Контейнер 20 фут", "Контейнер 40 фут"],
      volumeOpts: ["1–5 т", "5–20 т", "20–100 т", "100+ т", "Полный контейнер (FCL)"],
      productOpts: ["Гречиха", "Зелёная гречиха", "Гречневая мука", "Овсяные хлопья", "Красная чечевица", "Горох жёлтый", "Нут", "Пшеница"],
    },
    footer: {
      tagline:
      ...
      brandFeatures: ["Органические зерновые, бобовые и масличные", "Производство с сертификатом ЕС"],
      brandLocation: "Смоленская область, Россия",
      brandMission: "Работаем с импортёрами по всему миру,\nдоставляя качество и ценность.",
      quickLinks: "Быстрые ссылки",
      quickLinksItems: ["О нас", "Наши продукты", "Органик", "Экспорт", "Сертификаты", "Частная марка", "Галерея"],
  ...
  es: {
    ...
    organic: {
      ...
      wholesaleNote: "Suministro mayorista con documentación de exportación — orgánico y convencional, términos FOB / DDP disponibles.",
    ...
    certifications: {
      ...
      organicAvailableList: ["Trigo sarraceno", "Trigo sarraceno verde", "Harina de trigo sarraceno", "Copos de avena"],
      packagingSupplyTitle: "Envasado y Suministro",
      packagingSupplySub: "Soluciones flexibles para diferentes necesidades",
      packagingSupplyItems: [
        { title: "Envasado Minorista", size: "250 g – 5 kg", desc: "Opciones personalizadas disponibles" },
        { title: "Envasado Industrial", size: "Sacos 25 kg / 50 kg", desc: "Envasado de alta calidad" },
        { title: "Suministro a Granel", size: "500 – 1.000 kg\nBig Bags", desc: "Para pedidos de gran volumen" },
        { title: "Envío en Contenedor", size: "20 / 40 pies", desc: "Entrega segura y confiable" },
      ],
    },
    privateLabel: {
      ...
      trustItems: [
        { title: "Tierras Propias", desc: "10.000+ ha de tierras certificadas propias — control total del campo al procesamiento." },
        { title: "Control de Calidad", desc: "Pruebas de laboratorio internas en cada etapa según estándares internacionales." },
        { title: "Marca Propia", desc: "Envase listo para venta con diseño personalizado para su marca." },
        { title: "Documentos de Exportación", desc: "Certificados fitosanitarios, experiencia internacional con mercados globales." },
      ],
      whyBuyersTitle: "Por qué los compradores confían en Gavrilov Foods",
      whyBuyersItems: [
        { title: "Tierras Propias", desc: "10.000+ ha — control total de la semilla a la cosecha" },
        { title: "Control de Calidad", desc: "Pruebas de laboratorio internas en cada etapa" },
        { title: "Trazabilidad Completa", desc: "Cadena de suministro transparente del campo al envío" },
        { title: "Certificado Orgánico UE", desc: "Productos orgánicos certificados para categorías seleccionadas" },
        { title: "Experiencia Exportadora", desc: "Mercados internacionales, documentos fitosanitarios, FCL" },
      ],
    ...
    contact: {
      ...
      requestSubtitle: "Cuéntenos sus necesidades y nuestro equipo de exportación le enviará una oferta competitiva en 24 horas.",
      ...
      contactOriginNote: "Documentación fitosanitaria y de exportación disponible",
      ...
      formMessage: "Mensaje *",
      formMessagePlaceholder: "Volumen, envase, país de destino, requisitos especiales...",
      formPrivacyNote: "Por favor acepte la Política de Privacidad y los Términos para continuar",
      formSubmitBtn: "Solicitar Oferta de Exportación",
      whatsappExport: "WhatsApp Gestor de Exportación",
      trustIcons: ["Calidad de confianza", "Entrega puntual", "Precios competitivos", "Asociación a largo plazo"],
      featureBadges: [
        { title: "Certificado Orgánico UE", desc: "Productos orgánicos certificados para mercados globales." },
        { title: "Ped. mín. desde 22 TM", desc: "Pedido mínimo flexible desde 22 TM." },
        { title: "Marca Propia", desc: "Envasado personalizado y soluciones de marca propia." },
        { title: "Soporte de Exportación", desc: "Documentación completa y soporte logístico en cada etapa." },
        { title: "Respuesta Rápida", desc: "Respondemos en 24 horas en días hábiles." },
      ],
      sendRequest: "Envíenos su solicitud",
      selectProduct: "Seleccionar producto",
      selectPackaging: "Seleccionar envase",
      selectVolume: "Seleccionar volumen",
      privacyText: "Acepto la {privacyLink} y los {termsLink} de Gavrilov Foods y doy mi consentimiento para el procesamiento de mis datos personales con fines de consulta de exportación.",
      privacyLinkText: "Política de Privacidad",
      termsLinkText: "Términos y Condiciones",
      packagingOpts: ["Bolsas retail 250g – 5kg", "Sacos 25 / 50 kg", "Big Bags 500–1000 kg", "Contenedor 20 pies", "Contenedor 40 pies"],
      volumeOpts: ["1–5 TM", "5–20 TM", "20–100 TM", "100+ TM", "Contenedor completo (FCL)"],
      productOpts: ["Trigo sarraceno", "Trigo sarraceno verde", "Harina de trigo sarraceno", "Copos de avena", "Lentejas rojas", "Guisantes amarillos", "Garbanzos", "Trigo"],
    },
    footer: {
      tagline:
      ...
      brandFeatures: ["Granos orgánicos, legumbres y oleaginosas", "Producción certificada UE"],
      brandLocation: "Región de Smolensk, Rusia",
      brandMission: "Trabajando con importadores de todo el mundo\npara entregar calidad y valor.",
      quickLinks: "Enlaces Rápidos",
      quickLinksItems: ["Nosotros", "Nuestros Productos", "Orgánico", "Exportación", "Certificaciones", "Marca Propia", "Galería"],
