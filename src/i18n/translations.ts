  ...
  en: {
    ...
    contact: {
      ...
      featureBadges: [
        ...
        { title: "MOQ from 1 T", desc: "Flexible minimum order quantity from 1 T." },
  ...
  ru: {
    ...
    contact: {
      ...
      featureBadges: [
        ...
        { title: "МОК от 1 т", desc: "Гибкий минимальный заказ от 1 т." },
  ...
  es: {
    ...
    contact: {
      ...
      featureBadges: [
        ...
        { title: "Ped. mín. desde 1 TM", desc: "Pedido mínimo flexible desde 1 TM." },
